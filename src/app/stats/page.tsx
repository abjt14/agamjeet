  ...
  return (
    <main className="flex flex-col items-start justify-between gap-8 w-full">
      <header className="text-left flex flex-col gap-2">
        <h1 className="fade-in text-cinder-800 font-medium dark:font-normal dark:text-macaroni-and-cheese-300 text-4xl font-ebgaramond">
          Blog Metadata & Statistics
        </h1>
        <div
        ...
        >
          ...
          <span>&#10022;</span>
          <>
            <ArticleData type={"downloads"} slug="" downloadsType="any" />{" "}
            downloads
          </>
        </div>
      </header>
              ...
              <div className="flex flex-col gap-2 text-sm text-cinder-800 dark:text-cinder-500">
                ...
                <div
                  className={clsx(
                    "flex gap-1 justify-start items-center",
                    article.category !== "mock-test" ||
                      (article.category === "mock-test" && !article.answerKey)
                      ? "line-through opacity-50"
                      : ""
                  )}
                >
