  ...
  return (
    <html lang="en" className="dark font-sans relative">
      ...
      <body className={clsx(
        ...
        "text-macaroni-and-cheese-800 bg-macaroni-and-cheese-100 dark:text-cinder-300 dark:bg-cinder-950 leading-7 dark:selection:bg-macaroni-and-cheese-300 dark:selection:text-indigo-950"
      )}>
        <Navigation />
        {children}
      </body>
