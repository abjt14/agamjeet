  ...
  return (
    <main className="flex flex-col items-start justify-between gap-24 w-full">
      <header className="text-left flex flex-col gap-4">
        <h1 className="fade-in text-cinder-800 font-medium dark:font-normal dark:text-macaroni-and-cheese-300 text-4xl font-ebgaramond mb-4">
          Agamjeet Singh
        </h1>
        <p
          className="fade-in"
        ...
        >
          I find mathematics to be very intriguing and am constantly discovering
          new ideas, learning new things, and expanding my arsenal. I enjoy
          solving olympiad math and collecting intricate problems. I have also
          built a positive community on discord for people to learn, discuss,
          and collaborate.
        </p>
        <p
          className="fade-in"
        ...
        >
          When I am not crunching numbers, I like to play my electric guitar,
          listen to rock music, and watch anime.
        </p>
      </header>
              ...
              >
                ...
                >
                  <div className="flex gap-4 items-center">
                    <h2 className="text-cinder-800 font-semibold dark:font-medium sm:font-medium sm:dark:font-normal dark:text-macaroni-and-cheese-300 text-xl font-ebgaramond">
                      {article.title}
                    </h2>
                  </div>
