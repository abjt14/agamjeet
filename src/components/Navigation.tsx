...
export default function Navigation() {
  ...
  return(
    <nav className="w-full flex gap-4 justify-between items-center">
      ...
      <button
        className="p-2 hover:text-cinder-800 hover:dark:text-macaroni-and-cheese-300 transition-colors duration-150"
        onClick={() => {
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 theme-toggle">
