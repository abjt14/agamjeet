...
I admit that I usually design my mocks to be slightly (read: a lot) harder than the actual IOQM. The purpose of this is to prepare you for a harder-than-average test. However, as IOQM is closing in, I feel that such mocks are likely to lower your confidence, which is not ideal right now. Hence, I have tried my hardest to match this mock's difficulty with the real IOQM.
