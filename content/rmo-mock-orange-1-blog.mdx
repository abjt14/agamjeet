...
Let $x = \frac{p}{q}$ where $p,q$ are integers and $q \neq 0$. For the converse, consider the following triple: $$\left (\frac{p}{q}, \frac{p}{q}+p, \frac{p}{q} + p(q+2) \right ) $$
...
**Problem 4** ([All Russian Olympiad 2000](https://artofproblemsolving.com/community/c6h514293p2889231)) Let $-1 < x_1 < x_2 , \cdots < x_n < 1$ and $x_1^{13} + x_2^{13} + \cdots + x_n^{13} = x_1 + x_2 + \cdots + x_n$. Prove that if $y_1 < y_2 < \cdots < y_n$, then $$x_1^{13}y_1 + \cdots + x_n^{13}y_n < x_1y_1 + x_2y_2 + \cdots + x_ny_n. $$
